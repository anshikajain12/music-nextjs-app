...
function FeaturedCourses() {
  const featuredCourses = coursesData.courses.filter((course: Courses) => course.isFeatured)
  return (
    <div className="py-12 bg-gray-900">
      <div>
        <div className="text-center">
          <h2 className="text-base text-teal-600 font-semibold tracking-wide">FEATURED COURSES</h2>
          <p className="mt-2 text-3xl leading-8 font-extrabold tracking-light sm:text-4xl">Learn With the Best</p>
        </div>
      </div>
      <div className="mt-10">
